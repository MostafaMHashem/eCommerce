<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
       ...
       <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
              ...
              <li class="nav-item  open ">
                     ...
                     <li><a class="menu-item" href="{{route('admin.languages.create')}}" data-i18n="nav.dash.crypto">أضافة لغة جديده </a>
                     {{--  --}}
                     </li>
                     </ul>
              </li>
              ...
              <li class="nav-item"><a href=""><i class="la la-group"></i>
                     ...
                     <span class="badge badge badge-danger badge-pill float-right mr-2">{{App\Models\Main_Category::count()}}</span>
              ...
              <li class="nav-item"><a href=""><i class="la la-group"></i>
                     ...
                     <li><a class="menu-item" href="#" data-i18n="nav.dash.crypto">أضافة قسم فرعي جديد </a>
              ...
              <li class="nav-item"><a href=""><i class="la la-male"></i>
                            ...
                            <span class="badge badge badge-success badge-pill float-right mr-2">5</span>
                     ...
                     <ul class="menu-content">
                            ...
                            <li><a class="menu-item" href="#" data-i18n="nav.dash.crypto">أضافة متجر  </a>
              ...
              <li class="nav-item"><a href=""><i class="la la-male"></i>
                     ...
                     <ul class="menu-content">
                            ...
                            <li><a class="menu-item" href="" data-i18n="nav.dash.crypto">أضافة طالب </a>
                            </li>
                     </ul>
              </li>
