                                    ...
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.vendors.update', $vendor -> id)}}" method="POST"
                                            ...
                                            {{-- we put this input for validation purposes to check the photo validation 
                                                so the name here the same as the request file   --}}
                                            <input name="vend_id" value="{{$vendor -> id}}" type="hidden">
                                            {{-- عرض الصورة --}}
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img src="{{$vendor -> logo}}"
                                                        class="rounded-circle height-150" alt="لوجو المتجر  ">
                                                </div>
                                            </div>
                                            {{-- إضافة صورة --}}
                                            <div class="form-group">
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i> بيانات  القسم </h4>
                                                    ...
                                                    {{-- row 2 
                                                        رقم الهاتف و البريد الإلكتروني--}}
                                                    <div class="row">
                                                        
                                                        <div class="col-md-6 ">
                                                            <div class="form-group">
                                                                <label for="projectinput1"> رقم الهاتف </label>
                                                                <input type="text" value="{{$vendor -> mobile}}" id="name"
                                                                class="form-control"
                                                                placeholder="  "
                                                                name="mobile">
                                                                @error('mobile')
...
@section('script')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDKZAuxH9xTzD2DLY2nKSPKrgRi2_y0ejs&libraries=places&callback=initAutocomplete&language=ar&region=EG
        async defer"></script>
    {{-- تذكر ان هذا اللينك ما يقوم بتشغيل الخريطة قم بإضافة ال 
        key 
        الخاص بك  --}}
@stop